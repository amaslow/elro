...
class ItemsController extends AppController {
    ...
    public function view($id = null) {
        ...
        $this->set('item_vendor', $this->Supplier->findByOfficeVendor($item['Item']['VENDOR'],array('Supplier.ID')));
        if ($item['Item']['ITEM_S']!=''){
        ...
        if ($this->request->is('post') || $this->request->is('put')) {
            ...
            if ($this->Item->save($this->request->data)) {
                ...
                if ($this->Item->field('COMPONENT1') == null) {
                    ...
                    } elseif (strpos($this->Item->field('LVD_TR'), 'MISSING') === false && strpos($this->Item->field('EMC_TR'), 'MISSING') === false && strpos($this->Item->field('RF_TR'), 'MISSING') === false && strpos($this->Item->field('CPD_CE'), 'MISSING') === false && strpos($this->Item->field('EUP_TR'), 'MISSING') === false && strpos($this->Item->field('ROHS_TR'), 'MISSING') === false && strpos($this->Item->field('PHOTOBIOL_TR'), 'MISSING') === false && strpos($this->Item->field('IPCLASS_TR'), 'MISSING') === false && strpos($this->Item->field('EUP_STATUS'), '1000h') === false && strpos($this->Item->field('PAH_CE'), 'MISSING') === false && strpos($this->Item->field('REACH_CE'), 'MISSING') === false && strpos($this->Item->field('BATT_M'), 'MISSING') === false && strpos($this->Item->field('BATT_TR2'), 'MISSING') === false) {
                ...
                $this->Session->setFlash('Product has been modificied ', 'default', array('class' => 'success'));
